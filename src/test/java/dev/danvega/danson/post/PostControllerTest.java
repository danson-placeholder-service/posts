...
class PostControllerTest {
    ...
    void shouldCreateNewPostWhenGivenValidID() throws Exception {
        Post post = new Post(101,1,"This is my brand new post", "TEST BODY",null);
    ...
    void shouldUpdatePostWhenGivenValidPost() throws Exception {
        Post updated = new Post(101,1,"This is my brand new post", "UPDATED BODY",1);
        ...
        mockMvc.perform(put("/api/posts/101")
                .contentType("application/json")
                .content(json))
                .andExpect(status().isOk())
                .andExpect(content().json(json));
    ...
    void shouldDeletePostWhenGivenValidID() throws Exception {
        ...
        mockMvc.perform(delete("/api/posts/101"))
